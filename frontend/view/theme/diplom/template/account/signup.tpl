	...
	<div class="content-wrapper">
		...
		<table cellpadding="0" cellspacing="0">
			<tr<?php if($valid_username) : ?> class="warning"<?php endif; ?>>
				...
				<td class="form-info"><?php if($valid_username) { ?><span class="warning"><?php echo $valid_username; ?></span><?php } else { ?><span class="notice"><?php echo $info_username; ?></span><?php } ?></td>
			</tr>
			<tr<?php if($valid_email) : ?> class="warning"<?php endif; ?>>
				...
				<td class="form-info"><?php if($valid_email) { ?><span class="warning"><?php echo $valid_email; ?></span><?php } else { ?><span class="notice"><?php echo $info_email; ?></span><?php } ?></td>
			</tr>
			<tr<?php if($valid_password) : ?> class="warning"<?php endif; ?>>
				...
				<td class="form-info"><?php if($valid_password) { ?><span class="warning"><?php echo $valid_password; ?><?php } else { ?><span class="notice"><?php echo $info_password; ?></span><?php } ?></td>
			</tr>
			<tr<?php if($valid_password_confirm) : ?> class="warning"<?php endif; ?>>
				...
				<td class="form-info"><?php if($valid_password_confirm) { ?><span class="warning"><?php echo $valid_password_confirm; ?></span><?php } else { ?><span class="notice"><?php echo $info_password_confirm; ?></span><?php } ?></td>
			</tr>
			<tr>
				<td class="form-label"><?php echo $label_signin; ?></td>
				<td colspan="2"><input type="checkbox" name="signin" value="1"<?php if($signin) : ?> checked="checked"<?php endif; ?> /></td>
			</tr>
			<tr>
